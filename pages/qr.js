...
export default function QRCode() {
  return (
    <Layout title="marcoramos.me qr code">
      <section className="relative flex min-h-screen justify-center m-auto">
        <svg
        ...
        >
          <defs>
            ...
            <clipPath id="clipPath-corners-square-color-0-0">
              <path
                clipRule="evenodd"
            ...
            <clipPath id="clipPath-corners-dot-color-0-0">
              <circle cx="74" cy="74" r="24" transform="rotate(0,74,74)" />
            </clipPath>
            <clipPath id="clipPath-corners-square-color-1-0">
              <path
                clipRule="evenodd"
            ...
            <clipPath id="clipPath-corners-dot-color-1-0">
              <circle cx="426" cy="74" r="24" transform="rotate(90,426,74)" />
            </clipPath>
            <clipPath id="clipPath-corners-square-color-0-1">
              <path
                clipRule="evenodd"
            ...
            <clipPath id="clipPath-corners-dot-color-0-1">
          ...
          <rect
            ...
            height="500"
            width="500"
            clipPath="url('#clipPath-background-color')"
            fill="#fff"
          />
          <rect
            x="0"
          ...
          <rect
            ...
            height="112"
            width="112"
            clipPath="url('#clipPath-corners-square-color-0-0')"
            fill="#000000"
          />
          <rect
            x="50"
            ...
            height="48"
            width="48"
            clipPath="url('#clipPath-corners-dot-color-0-0')"
            fill="#000000"
          />
          <rect
            x="370"
            ...
            height="112"
            width="112"
            clipPath="url('#clipPath-corners-square-color-1-0')"
            fill="#000000"
          />
          <rect
            x="402"
            ...
            height="48"
            width="48"
            clipPath="url('#clipPath-corners-dot-color-1-0')"
            fill="#000000"
          />
          <rect
            x="18"
            ...
            height="112"
            width="112"
            clipPath="url('#clipPath-corners-square-color-0-1')"
            fill="#000000"
          />
          <rect
            x="50"
            ...
            height="48"
            width="48"
            clipPath="url('#clipPath-corners-dot-color-0-1')"
            fill="#000000"
          />
        </svg>
      </section>
