      ...
      <section className="relative flex flex-col justify-center text-justify overflow-hidden">
        ...
        <div className="text-container">
          ...
          <p>
            ...
            your personal information, please contact us at marco@marcoramos.me.
          </p>
        </div>
        <div className="text-container">
        ...
        <div className="text-container">
          ...
          <ul>
            ...
            <li>
              ...
              legal reasons, and/or possibly for contractual reasons.
            </li>
            <li>To fulfill and manage your orders for contractual reasons.</li>
            <li>
              To manage user accounts for the purpose of managing our
        ...
        <div className="text-container">
          ...
          <p>
            ...
            Regulation (GDPR) and ensuring the protection of your personal data.
            This section outlines our compliance with GDPR requirements.
          </p>
        </div>
        <div className="text-container">
          <h2>Data Protection Principles</h2>
          <p>
            We adhere to the following data protection principles as required by
            GDPR:
          </p>
          <ul>
            <li>
              <strong>Lawfulness, Fairness, and Transparency</strong>: We
              process personal data lawfully, fairly, and in a transparent
              manner.
            </li>
            <li>
              <strong>Purpose Limitation</strong>: We collect personal data for
              specified, explicit, and legitimate purposes and do not process it
            ...
            <li>
              <strong>Accuracy</strong>: We ensure that personal data is
              accurate and, where necessary, kept up to date.
            </li>
            <li>
              <strong>Storage Limitation</strong>: We keep personal data in a
              form that permits identification of data subjects for no longer
              than is necessary for the purposes for which the personal data is
              processed.
            </li>
            <li>
              <strong>Integrity and Confidentiality</strong>: We process
              personal data in a manner that ensures appropriate security,
        ...
        <div className="text-container">
          ...
          <ul>
            <li>
              ...
              access to your personal data and obtain information about how we
              process it.
            </li>
            <li>
        ...
        <div className="text-container">
          ...
          <p>
            ...
            have any questions about this privacy policy or our data protection
            practices, please contact our DPO at marco@marcoramos.me.
          </p>
        </div>
        <div className="text-container">
          ...
          <ul>
            <li>
              <strong>Consent</strong>: You have given your consent for us to
            ...
            <li>
              <strong>Legal Obligation</strong>: The processing is necessary for
              compliance with a legal obligation to which we are subject.
            </li>
            <li>
              <strong>Legitimate Interests</strong>: The processing is necessary
              for the purposes of our legitimate interests, except where such
        ...
        <div className="text-container">
          ...
          <p>
            ...
            Economic Area (EEA) that do not provide the same level of data
            protection as the EEA. In such cases, we ensure that appropriate
        ...
        <div className="text-container">
          <h2>Complaints</h2>
          <p>
            If you believe that we have not complied with your data protection
            rights, you have the right to lodge a complaint with a supervisory
            authority, in particular in the EU Member State where you reside,
        ...
        <div className="text-container">
          ...
          <p>
            ...
            <Link id="cokiee-policy-link" href="/cokiee-policy">
              <em>Cookie Policy</em>.
            </Link>
          </p>
        </div>
