        ...
        <View key={type + i} style={styles.leftSectionSpacer}>
          ...
          {type === "work"
            ? d.description.map((d, i) => (
                <Text style={[styles.leftText, styles.leftText4]} key={i}>
                  • {d}
                </Text>
              ))
            : null}
    ...
    <BaseResume>
      ...
      <View style={styles.body}>
        ...
        <View style={styles.bodyRight}>
          <View style={styles.sectionSpacer}>
            <Text style={[styles.sectionHeader, styles.alignRight]}>
              Contacts
            </Text>
            <Text style={[styles.alignRight, styles.contacts]}>
              {cvdata.email.primary}
            </Text>
            <Text style={[styles.alignRight, styles.contacts]}>
      ...
      <View style={styles.footer}>
        <Text style={styles.footertext}>
          {cvdata.full_name} Last Update: {cvdata.last_update}
        </Text>
      </View>
    </BaseResume>
  );
